...
\newcommand*{\getTitle}{Integration of Mixed-Criticality into Dynamic Task Migration for Real-Time Embedded Systems}
\newcommand*{\getTitleGer}{}
\newcommand*{\getAuthor}{Octavio Ivan Delgadillo Ruiz}
\newcommand*{\getDoctype}{Proposal for PhD Project}
